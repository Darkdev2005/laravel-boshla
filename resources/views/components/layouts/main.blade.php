...
<head>
    <meta charset="utf-8">
    <title>|{{ $title ?? 'Taskin - Cleaning Services' }} </title>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="{{ route('about') }}"><i class="fa fa-angle-right mr-2"></i>About
                        Us</a>

                    <a class="text-white mb-2" href="{{ route('services') }}"><i class="fa fa-angle-right mr-2"></i>Our
                        Services</a>
                    <a class="text-white mb-2" href="{{ route('project') }}"><i class="fa fa-angle-right mr-2"></i>Our
                        Projects</a>
...
<a href="#" class="btn btn-primary px-3 back-to-top">
    <i class="fa fa-arrow-up"></i> <!-- Arrow pointing up icon -->
