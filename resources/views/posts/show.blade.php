        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row mb-4">
                        ...
                        <form action="{{ route('posts.destroy', ['post' => $post->id]) }}" method="POST"
                            onsubmit="return confirm(' Rostdan ham o\'chirilsinmi?');">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <!-- Qo'shimcha kommentlar shu yerda davom etadi -->
                        </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <!-- Sidebar: kategoriyalar, oxirgi postlar va boshqa elementlar uchun -->
                    <div class="mb-5">
                            ...
                            <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                                ...
                                <div class="d-flex flex-column pl-3">
                                    <a class="text-dark mb-2"
                                        href="{{ route('posts.show', ['post' => $recent_post->id]) }}">
                                        {{ $recent_post->title }}
                                    </a>
                                    <div class="d-flex">
